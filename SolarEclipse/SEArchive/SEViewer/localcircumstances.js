...
export function getElementsQueried() {
    ...
    const hasInvalid = values.some(val => val === null || !Number.isFinite(val));
    if (hasInvalid) {
...
export function getLocalCircumstances(Φ, λ, height) {
    ...
    //return {t:t, UT: UT, mag: G, UTMaximum: UTMaximum, h:h, m:m, elements: o, A:A};
    return { elements: o, sinh: sinh, h: h, q: q, S: S, τ: τ, m:m, firstContact: firstContact, secondContact: secondContact, thirdContact: thirdContact, lastContact: lastContact, t: t, UT: UT, UTFirstContact: UTFirstContact, UTSecondContact: UTSecondContact, UTSecondContact: UTSecondContact, UTMaximum: UTMaximum, UTThirdContact: UTThirdContact, UTLastContact: UTLastContact, mag: G, ratio: A };
}